...
class ListFoodActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        foodList = listOf(
            ...
            Food("Cheesecake", "Cheesecake yang terbuat dari bahan bahan pilihan", R.drawable.cheesecake),
            Food("Cireng", "Cireng asli cipadung yang banyak pilihan rasanya", R.drawable.cireng)
        )

        adapter = FoodAdapter(foodList)
        recyclerView.adapter = adapter

        // Tombol Order dan navigasi ke OrderActivity
        ...
        // Set insets untuk menyesuaikan padding
